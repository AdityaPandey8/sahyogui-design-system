    ...
    <div className={cn("min-h-screen bg-background flex", crisisMode && "ring-2 ring-danger ring-inset")}>
      ...
      <aside className={cn(
        ...
        <div className="flex items-center gap-2 border-b px-3 h-16 shrink-0">
          {sidebarOpen && <span className="text-sm font-bold truncate">{currentNgo.name}</span>}
        ...
        <header className="sticky top-0 z-40 border-b bg-background/80 backdrop-blur-md">
          <div className="flex h-16 items-center justify-between px-4 lg:px-6">
            ...
            <div className="flex items-center gap-2">
              <NotificationBell notifications={ngoNotifications} autoToast={{ message: "📋 New issue reported in your area", description: "Flooded road near Sector 14 needs immediate attention", delay: 3500 }} />
              <ThemeToggle />
            </div>
          </div>
        </header>
